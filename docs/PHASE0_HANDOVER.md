...
5. **Lens key naming conflict:** Automaat allowlists `LensProfileEnable` (`tool-contracts.ts:81`); LR_SDK_NOTES and the directive say `EnableLensCorrections`. S5 reads back both, and write test B writes the former.
